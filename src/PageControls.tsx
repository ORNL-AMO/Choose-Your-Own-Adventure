    ...
    groups: [
        {
            ...
            choices: [
                ...
                Projects[Pages.steamTrapsMonitoring].getProjectChoiceControl(),
                ...
                Projects[Pages.thAirCurtainDoors].getProjectChoiceControl(),         
                Projects[Pages.turnOffOneRTO].getProjectChoiceControl(),         
                Projects[Pages.thReduceCombustionAirFlow].getProjectChoiceControl(),
    ...
    groups: [
        {
            ...
            choices: [
                ...
                Projects[Pages.thProgramableHVAC].getProjectChoiceControl(),         
                Projects[Pages.thRunDriersOnly].getProjectChoiceControl(),          
